...
class TenantAwareOpaqueTokenIntrospector(
    ...
    private val introspectorFactory: OpaqueTokenIntrospectorFactory = OpaqueTokenIntrospectorFactory()
    ...
    override fun introspect(token: String): OAuth2AuthenticatedPrincipal {
        ...
        return introspectorFactory.introspect(token, opaqueProvider.issuer)
    }
